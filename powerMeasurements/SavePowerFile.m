function p = SavePowerFile(powers, varargin)
...
power_file.V     = cell2mat(powers{1});
power_file.mW    = cell2mat(powers{2});


power_file.p     = polyfit(power_file.V, power_file.mW, power_file.order);
